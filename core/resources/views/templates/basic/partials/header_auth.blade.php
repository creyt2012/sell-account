        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.deposit.history') }}">@lang('Thanh toán')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.orders') }}">@lang('Đơn hàng')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.profile.setting') }}">@lang('Profile')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.change.password') }}">@lang('Đổi Password')</a>
                    </li>
                    <li class="nav-item d-block">
                        <div class="accounts-buttons d-flex align-items-center">
                            <a href="{{ route('user.logout') }}" class="accounts-buttons__link btn btn--base btn--sm">
                                <i class="fas fa-sign-in-alt"></i> @lang('Đăng Xuất')
                            </a>
                        </div>
                    </li>
                </ul>
