        ...
        <div class="container">
            <div class="row justify-content-center gy-5">
                ...
                <div class="col-xl-2 col-sm-6 col-xsm-6">
                    <div class="footer-item">
                        <h5 class="footer-item__title">@lang('Liên kết nhanh')</h5>
                        <ul class="footer-menu">
                            <li class="footer-menu__item"><a href="{{ route('products') }}" class="footer-menu__link">@lang('Sản phẩm')</a></li>
                            <li class="footer-menu__item"><a href="{{ route('user.login') }}" class="footer-menu__link">@lang('Đăng nhập')</a></li>
                            <li class="footer-menu__item"><a href="{{ route('user.register') }}" class="footer-menu__link">@lang('Đăng ký') </a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-xsm-6">
                    <div class="footer-item">
                        <h5 class="footer-item__title">@lang('Tài Liệu')</h5>
                        <ul class="footer-menu">
                            <li class="footer-menu__item"><a href="{{ route('blog') }}" class="footer-menu__link">@lang('Hướng dẫn') </a></li>
                            <li class="footer-menu__item"><a href="{{ route('contact') }}" class="footer-menu__link">@lang('Liên hệ') </a></li>
                ...
                <div class="col-xl-3 col-sm-6 col-xsm-6">
                    <div class="footer-item">
                        <h5 class="footer-item__title">@lang('Liên Hệ')</h5>
