                    ...
                    <div class="contact-info-wrapper row">
                        <div class="col-lg-12 col-md-6">
                            <div class="contact-info">
                                ...
                                <div class="contact-info__content">
                                    <h5 class="contact-info__title">@lang('Gửi mail cho chúng ')</h5>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="contact-info">
                                ...
                                <div class="contact-info__content">
                                    <h5 class="contact-info__title">@lang('Điện thoại')</h5>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="contact-info">
                                ...
                                <div class="contact-info__content">
                                    <h5 class="contact-info__title">@lang('Địa ')</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-0">
                                        <button class=" btn btn--base w-100" type="submit">@lang('Gửi tin nhắn')</button>
                                    </div>
                                </div>
                            </div>
                        </form>
