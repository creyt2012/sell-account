...
<div class="row">
    ...
    <div class="td-wrapper">
        <span class="">
            ...
            <span class="text--base" title="@lang('charge')">
                {{ number_format($deposit->charge, 0, ',', '.') }}
            </span>
        </span>
        <strong class="d-block" title="@lang('Amount with charge')">
            {{ number_format($deposit->amount + $deposit->charge, 0, ',', '.') }}
            {{ __($general->cur_text) }}
        </strong>
    </div>
</td>
...
<td>
    <div class="td-wrapper">
        <span>
            1 {{ __($general->cur_text) }} = {{ number_format($deposit->rate, 0, ',', '.') }}
            {{ __($deposit->method_currency) }}
        </span>
        <strong class="d-block">{{ number_format($deposit->final_amo, 0, ',', '.') }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">@lang('Chi tiết')</h6>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-dark btn--sm" data-bs-dismiss="modal">@lang('Thoát')</button>
            </div>
        </div>
    </div>
</div>
