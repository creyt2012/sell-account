    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table--responsive--md custom--table">
                <thead>
                    <tr>
                        <th>@lang('Giao dịch')</th>
                        <th>@lang('Đã đặt hàng tại')</th>
                        <th>@lang('Số tiền')</th>
                        <th>@lang('Số lượng')</th>
                        <th>@lang('Chi tiết')</th>
                    </tr>
                ...
                <tbody>
                    @forelse($orders as $order)
                        ...
                        <tr>
                            ...
                            <td>
    <div class="td-wrapper">
        <span class="d-block">{{ $qty }} @lang('Sản phẩm') x {{ number_format($perUnitPrice, 0, ',', '.') }} {{ __($general->cur_text) }}</span>
        <span class="fw-bold">
            {{ number_format($order->total_amount, 0, ',', '.') }} {{ __($general->cur_text) }}
        </span>
    </div>
</td>
